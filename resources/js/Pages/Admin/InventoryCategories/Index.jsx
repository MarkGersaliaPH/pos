...
function Index({ auth, items }) {
    ...
    const body = items.data.map((data) => ({
        ...
        data: [
            <span className="flex gap-3 items-center"> <span>{data.name}</span>
            </span>,
    ...
    const actions = {
        ...
        edit: "admin.inventory-categories.edit",
    };
            ...
            >
                ...
                <Card>
                    <CardHeader title={"Categories List"}>
                        <PrimaryButton href={route("admin.inventory-categories.create")}>
                            Create
                        </PrimaryButton>
                    </CardHeader>
                    <Table
