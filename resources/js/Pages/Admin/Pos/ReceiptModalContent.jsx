...
function ReceiptModalContent({ data }) {
    const handlePrint = () => {
        window.open(route("admin.order.generatepdf", data.id), "_blank");
        location.reload();
    };
    return (
        <div className="">
            <div id="receipt">
                <h2 className="invoice-title text-center mb-3 font-bold">
                    My Store
                </h2>
                <div className="my-1 pb-1 border-b-4 border-dotted">
